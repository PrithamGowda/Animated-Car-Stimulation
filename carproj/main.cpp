...
void display1(void)
{
    ...
    display_string(190,540,"Adichunchanagiri Institute of Technology Karnataka, Chikmagalur",1);
    ...
    display_string(500,420,"Preetham Gowda and Daivik M D",2);
    glutPostRedisplay();
    glutSwapBuffers();
